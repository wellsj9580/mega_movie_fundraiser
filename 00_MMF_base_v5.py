...
summary_headings = ["Popcorn", "M&M's", "Pita Chips", "Water", "Orange Juice", "Snacks Profit", "Ticket Profit", "Ticket Profit"]
...
summary_frame = pandas.DataFrame(summary_datas_dict)
...
print()
print("*** Ticket / Snacks Information *** ")
